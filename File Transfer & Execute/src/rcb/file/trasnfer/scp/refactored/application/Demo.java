...
public class Demo implements Runnable {
 ...
 public static void testParseSubCommands() {
     ...
     assert parsed.get(0).getClass() == CommandLine.class;
     assert parsed.get(1).getClass() == CommandLine.class;
     
     //parsed.get(0).getClass();

     //CommandLine git = (CommandLine) parsed.get(0);
