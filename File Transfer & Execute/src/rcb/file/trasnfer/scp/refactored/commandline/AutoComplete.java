...
import rcb.file.trasnfer.scp.refactored.commandline.CommandLine.Model.ArgSpec;
import rcb.file.trasnfer.scp.refactored.commandline.CommandLine.Model.CommandSpec;
import rcb.file.trasnfer.scp.refactored.commandline.CommandLine.Model.OptionSpec;
...
//                "\n";
    ...
    private static String generateFunctionForCommand(String functionName, String commandName, CommandLine commandLine) {
        ...
        // LATER generate completion lists for other option types:
