 ...
 */
package rcb.file.trasnfer.scp.refactored.commandline;
...
import rcb.file.trasnfer.scp.refactored.commandline.CommandLine.Help.Ansi.IStyle;
import rcb.file.trasnfer.scp.refactored.commandline.CommandLine.Help.Ansi.Style;
import rcb.file.trasnfer.scp.refactored.commandline.CommandLine.Help.Ansi.Text;
import rcb.file.trasnfer.scp.refactored.commandline.CommandLine.Model.*;

import static java.util.Locale.ENGLISH;
import static rcb.file.trasnfer.scp.refactored.commandline.CommandLine.Model.ArgsReflection.abbreviate;
import static rcb.file.trasnfer.scp.refactored.commandline.CommandLine.Help.Column.Overflow.SPAN;
import static rcb.file.trasnfer.scp.refactored.commandline.CommandLine.Help.Column.Overflow.TRUNCATE;
import static rcb.file.trasnfer.scp.refactored.commandline.CommandLine.Help.Column.Overflow.WRAP;
...
//                return result;
        ...
        public static class TextTable {
            ...
            private static int length(Text str) {
                return str.length; // count some characters as double length
            }
            ...
            private int copy(BreakIterator line, Text text, Text columnValue, int offset) {
                ...
                for (int start = line.first(), end = line.next(); end != BreakIterator.DONE; start = end, end = line.next()) {
                    ...
                    if (columnValue.maxLength >= offset + done + length(word)) {
                        done += copy(word, columnValue, offset + done); // localized length
                    } else {
                        break;
                    }
                }
